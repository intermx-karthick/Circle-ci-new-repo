...
describe('VerifySummaryOfAudienceAndMarketInAdddScenario', function () {
    ...
    it('CreateMarketAndInventoryPlan', function () {
        ...
        cy.log("step 3: Click 'Add Scenario' to create an new scenario")
        cy.log("step 4: Create 'Audience' and 'Market' on Market Plan page, And also validtate the recently added 'Targetted Audience and Targetted Markets' on the Summary page")
        cy.log("step 5: Again Select the another 'Audience' and 'Market' on Market Plan page, And also validate the newly added in the Summary page")
        cy.log("step 6: Remove the newly added Audience and Market info in the Summary page")
        cy.log("step 7: Click the Generate button without selects any Audience, Market, Operator and Media and Validate the validation message on the Market Plan page")
        cy.log("step 8: Selects to Inventory tab and Create 'Audience' and 'Market' on Inventory Plan page, And also validtate the recently added 'Targetted Audience and Targetted Markets' on the Summary page")
        cy.log("step 9: Remove the newly added Audience and Market info in the Summary page")
        cy.log("step 10: Click the Generate button without selects any Audience, Market, Operator and Media and Validate the validation message on the Inventory Plan page")
       ...
       workspacepage.clickOnAddScenario()
        ...
        workspacepage.clickOnGenerateButton()
        //verify error message
         cy.get('.mat-snack-bar-container').should('contain.text', 'Inventory Plan should have atleast one Audience and MarketDISMISS');
         //select  audience
         workspacepage.selectAudience("Persons 0+ yrs");
        //  cy.get(':nth-child(1) > .mat-focus-indicator > .mat-button-wrapper > .mat-icon').click({ multiple: true });
        //  cy.get(':nth-child(2) > .mat-list-item-content > .mat-pseudo-checkbox').click();
