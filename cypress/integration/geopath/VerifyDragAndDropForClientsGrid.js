...
describe('VerifyDragAndDropForClientsGrid', function () {
    ...
    it('VerifyDragAndDropForClientsGrid', function () {
        cy.wait(20000)
        recordsmanagementPage.clickOnRecordsManagementIcon();
        recordsmanagementPage.clickOnClient();
        cy.get('mat-header-cell[role="columnheader"]').eq(2).contains('Agency')

        cy.get('mat-header-cell[role="columnheader"]').eq(3).contains('Client Code')
        ...
        cy.wait(2000)
        cy.get('mat-header-cell[role="columnheader"]').eq(2).contains('Client Code')
        cy.get('mat-header-cell[role="columnheader"]').eq(3).contains('Agency')
        cy.wait(2000)
