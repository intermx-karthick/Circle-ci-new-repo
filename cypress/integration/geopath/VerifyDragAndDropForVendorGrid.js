...
describe('VerifyDragAndDropForVendorGrid', function () {
    ...
    it('VerifyDragAndDropForVendorGrid', function () {
        cy.wait(20000)
        recordsmanagementPage.clickOnRecordsManagementIcon();
        cy.get('.mat-header-row > .cdk-column-parentCompany').eq(0).contains('Parent Company')
        cy.get('.mat-header-row > .cdk-column-pubA_id').eq(0).contains('PUB ID')
