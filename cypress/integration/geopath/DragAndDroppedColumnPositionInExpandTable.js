...
describe('VerifyDragAndDroppedColumnPositionInExpandTable', function () {
    ...
    it('CreateInventoryPlan', function () {
       ...
       // cy.get('mat-header-row>mat-header-cell').eq(3).contains('Market')
        ...
        // //verify column names of drag and dropped columns in expand table
        // cy.get('#inventory-plan-dialog-fullscreen > .mat-table > .mat-header-row > .cdk-column-aud_name').contains('Audience')
        // cy.get('#inventory-plan-dialog-fullscreen > .mat-table > .mat-header-row > .cdk-column-freq_avg').contains('Target In-Market Frequency')
