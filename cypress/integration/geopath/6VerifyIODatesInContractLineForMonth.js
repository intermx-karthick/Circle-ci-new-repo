...
describe('VerifyIODatesInContractLineForMonth', function () {
    ...
    it('contract', function () {
        ...
        //case 1: Number of period-1 for Month
        ...
        cy.xpath("//span[text()=' Month ']").click()
     ...
     //   cy.get('input[formcontrolname="endDate"]').contains('6/11/2021').should('be.visible');
        cy.get('[class="io-elements"]>div>form>div>mat-form-field>div>div>div>input').should('have.value', '5/13/2021');

        //case 2: Number of period-2 for Month
        cy.get('form>mat-form-field>div>div>div>[formcontrolname="numberOfPeriods"]').clear();
        //cy.get('#mat-input-30').clear();
        //cy.get('#mat-input-31').clear();
        cy.xpath("//mat-label[text()='Start Date']//parent::label//parent::span//parent::div//input[@formcontrolname='startDate']").eq(1).clear()
       ...
       //cy.get('#mat-input-30').clear();
        cy.wait(2000)
        //cy.get('#mat-input-30').type('6/1/2021');
        //cy.get('[class="io-elements"]>div>form>div>mat-form-field>div>div>div>input').should('have.value', '6/1/2021');
        cy.get('form>mat-form-field>div>div>div>[formcontrolname="numberOfPeriods"]').click();
        cy.get('[class="io-elements"]>div>form>div>mat-form-field>div>div>div>input').should('have.value', '5/13/2021');

       // cy.get('[class="io-elements"]>div>form>div>mat-form-field>div>div').contains('div input', '7/1/2021').should('have.value', '7/1/2021');


        //case 3: Number of period-3 for Month
        cy.get('form>mat-form-field>div>div>div>[formcontrolname="numberOfPeriods"]').clear();
