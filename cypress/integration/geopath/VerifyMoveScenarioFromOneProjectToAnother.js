...
describe('VerifyMoveScenarioFromOneProjectToAnother', function () {
    ...
    it('VerifyMarketPlanGridValues', function () {
        ...
        cy.xpath("//mat-label[text()='Project Name']//parent::label//parent::span//parent::div//input").click();
        cy.xpath("//mat-label[text()='Project Name']//parent::label//parent::span//parent::div//input").clear();
        cy.xpath("//mat-label[text()='Project Name']//parent::label//parent::span//parent::div//input").type(campName1);
        
        cy.xpath("//mat-label[text()='Project Description']//parent::label//parent::span//parent::div//textarea").click()
        cy.xpath("//mat-label[text()='Project Description']//parent::label//parent::span//parent::div//textarea").clear()
        cy.xpath("//mat-label[text()='Project Description']//parent::label//parent::span//parent::div//textarea").type(campName1)
       // cy.get('.imx-button-primary > .mat-button-wrapper').click();
       cy.wait(10000)
       cy.xpath("//span[text()='Create Project']").click()
       cy.wait(50000)
      cy.get('.caption').click()
