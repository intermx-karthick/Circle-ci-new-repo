...
describe('VerifyMarketPlanGridValues', function () {
    ...
    it('VerifyMarketPlanGridValues', function () {
       ...
       const campName = workspacepage.generate_random_string(8)
        ...
        //assert trp
        cy.get('.mat-ripple > .cdk-column-trp').should('have.text', (' 61.908 '))
        cy.get('.mat-ripple > .cdk-column-reach').should('have.text', (' 3.39% '))
        cy.get('.mat-ripple > .cdk-column-reachNet').should('have.text', (' 660,621 '))
        cy.get('.mat-ripple > .cdk-column-frequency').should('have.text', (' 18.25 '))
        cy.get('.mat-ripple > .cdk-column-targetInMarketImp').should('have.text', (' 12,056,083 '))
        cy.get('.mat-ripple > .cdk-column-targetImp').should('have.text', (' 12,326,532 '))
        cy.get('.mat-ripple > .cdk-column-totalImp').should('have.text', (' 13,094,556 '))
