...
@Component({
  selector: 'app-explore-layers-template',
  templateUrl: './explore-layers-template.component.html',
  styleUrls: ['./explore-layers-template.component.less']
})
export class ExploreLayersTemplateComponent implements OnInit {
