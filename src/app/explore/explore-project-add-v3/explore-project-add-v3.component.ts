...
@Component({
  selector: 'app-explore-project-add-v3',
  templateUrl: './explore-project-add-v3.component.html',
  styleUrls: ['./explore-project-add-v3.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ExploreProjectAddV3Component implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ExploreProjectAddV3Component>,
