...
export class VendorGroupAbstract implements OnDestroy {
  ...
  private freeUp$ = new Subject();
  public searchText;

  constructor(private inventoryApi: VendorService, public cdRef: ChangeDetectorRef) {}
