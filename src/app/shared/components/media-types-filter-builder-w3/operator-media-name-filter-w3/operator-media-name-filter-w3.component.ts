...
@Component({
  selector: 'app-operator-media-name-filter-w3',
  templateUrl: './operator-media-name-filter-w3.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class OperatorMediaNameFilterComponentW3 extends AbstractMediaFilterW3<any> implements OnInit, OnDestroy , AfterViewInit{
  ...
  handleAPIsResponse([summaries, elastic]: readonly [any, any], selected): void {
    ...
    const mediaNames = AbstractMediaFilterW3.prepareOptionsFromData(summaries, elastic, selected);
