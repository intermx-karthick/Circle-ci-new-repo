import { Directive, Input, ElementRef, HostListener, Renderer2, SimpleChanges, OnChanges, OnDestroy } from '@angular/core';
...
export class TooltipV2Directive implements OnChanges, OnDestroy {
  @Input('tooltipv2') tooltipTitle: string;
  ...
  @HostListener('mouseenter') onMouseEnter() {
    ...
    if (this.el.nativeElement && !this.placement) {
